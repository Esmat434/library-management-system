...
urlpatterns = [
    ...
    path('resend_account_token/',AccountVerifiedResendTokenView.as_view(),name='resend_account_token'),
    ...
    path('forgot_password_token/',ForgotPasswordResendLinkView.as_view(),name='forgot_password_token'),
